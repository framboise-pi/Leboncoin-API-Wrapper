    ...
    def loadUserAgent(self, *args, **kwargs):
        ...
        if self.custom:
            ...
            if self.browser and self.browser not in self.browsers:
                ...
                raise RuntimeError('Sorry "{self.browser}" browser is not valid, valid browsers are [{", ".join(self.browsers)}].')
            ...
            if self.platform not in self.platforms:
                ...
                raise RuntimeError('Sorry the platform "{self.platform}" is not valid, valid platforms are [{", ".join(self.platforms)}]')
            ...
            if not filteredAgents[self.browser]:
                ...
                raise RuntimeError('Sorry "{self.browser}" browser was not found with a platform of "{self.platform}".')
